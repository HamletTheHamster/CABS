...
to be a good approximation, and thus
...
\begin{equation}
  P_{S} = \frac{G_{B}P_{P}L\omega_{S}\Gamma_{B}k_{b}T}{4\Omega_{B}}.
\end{equation}

It may be noted that this is equivalent to the expression for the forward Stokes spontaneous Brillouin scattering process derived by Kharel et al in 2016.\cite{kharel2016noise} While each describe seemingly distinct processes, the shared underlying physics of light coupling to acoustic waves leads to identical scaling laws for scattered power in the low-gain (spontaneous) regime.
