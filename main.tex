...
\begin{figure}[t]
  ...
  \caption{1cm UHNA3}\label{fig:1cmUHNA3}
\end{figure}
...
\begin{equation}
    ...
    \label{Signal coupled-amplitude wave equation}
\end{equation}
\\
Integrating Eq. \ref{Signal coupled-amplitude wave equation} along the effective length gives the amplitudes of each optical field,
\\
\begin{equation}
