...
The Brillouin signal for a sensitivity of $P_{Signal}$ = 5\,fW is shown in Fig. \ref{fig:5fWSensitivity} and offers a signal-to-noise ratio (SNR) greater than 5, determined by taking the ratio of the peak spectral density at the center frequency (9.18 GHz) and the standard error in the spectral density completely off resonance. Assuming a normal noise distrubution profile, an SNR of 5 is equivalent to a 5$\sigma$ confidence interval, or 99.7\% confidence in the statistical significance of this measurement. Parameters for this measurement and calculation of on-resonance scattered power are listed in Table \ref{tab:sensitivity}.
...
We performed an additional experiment to characterize the phase matching tolerance of the instrument. In this experiment, a series of measurements were taken of 1 cm of UHNA3 with varying phase mismatch between the pump and probe lasers while optical powers were constant. According to Eq. \ref{Eq:Theoretical Framework:Scattered Power} and equally by Eq. \ref{Eq:Phi}, we expect the amplitudes of these measurements to trace out a $sinc^{2}$ function. The result of this experiment is plotted in Fig. \ref{fig:Phase-Match}, with the peak amplitude of each individual measurement represented by a point.
