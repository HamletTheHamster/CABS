%\documentclass[sn-nature,twocolumn]{sn-jnl}% Style for submissions to Nature Portfolio journals (remove twocolumn before submission)
...
\affil[4]{\orgdiv{Department}, \orgname{Organization}, \orgaddress{\street{Street}, \city{City}, \postcode{10101}, \state{State}, \country{Country}}}
...
\subsection*{Coupled-wave equations}\label{Theoretical Framework: Coupled-wave equations}
...
In light of this self-reinforcing process, it becomes apparent why it would be desireable to seed the weak Stokes optical field with a high-powered
